...
namespace SCO2
{
	public class CTurbine:CRotator  
	{
		public double powerOut = 0;
		/// <summary>
		/// 涡轮换算转速设计点值
		/// </summary>
		public double CNTds;
		...
		public PortofGas BleedIn, PToutport,realInport;
		public double Tin, Pin,P5;
		public double TurbinDH = 0;
		public double EffScalerModifier = 0;
		public CTurbine(Engine eng)
		{
		...
		public override void Run(int N)
		{
			...
			double WorkNeed = 0, MIC = 0;
			MechPort.ReadPort(ref WorkNeed, ref this.PNC, ref MIC);
			MapCal(this.Pin, this.Tin, w1);
			double PR = this.Pin / this.P5;
			ThTurbin(PR, this.Effmap, this.Tin, this.Pin, ref t2);
			...
			w2 = w1 ;
			this.WorkProvide = this.TurbinDH * w1;
			WorkNeed =WorkNeed + this.powerOut;
			double Error0 = (WorkProvide - WorkNeed) / WorkProvide;
			Engine.ErrorList.Add(Error0);

			h2=(h2*w2 +h3 *w3 )/(w2+w3);
			...
			double P5_cal = this.Pin / this.PRmap;
			double Error1 = (P5_cal - this.P5) / P5_cal;
			Engine.ErrorList.Add(Error1);

			OutPort.WritePort(t2, this.P5, h2, s2, w2, d2);
			realInport.WritePort(this.Tin, this.Pin, h1, s1, w1 , d1);
			PToutport.WritePort(this.Tin, this.Pin, h1, s1, w1 , d1);
		}
